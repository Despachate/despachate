...
export class InventarioService {
  ...
  insert(inventario: any){
    return this.http.post(this._url, inventario).pipe(map((res:any)=>{
      return res;
    }), catchError((err: any)=>{
  ...
  update(id: string, inventario: any){
    return this.http.put(`${this._url}/${id}`, inventario).pipe(map((res:any)=>{
      return res;
    }), catchError((err: any)=>{
